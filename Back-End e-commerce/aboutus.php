...
<body>
    ...
    <div class="aboutusclass">
        <h5 style="font-size: 20px;">За нас</h5>
        <p>Ние сме Seafood Shop и сме на пазара от 14 години. Ако търсите богат избор,<br>
        нашият магазин е правилното място за Вас</p>
        <h6 style="font-size: 20px;">Условия за поръчка</h6>
        <p>Минимална поръчка: 20лв.
        Доставка до 1 час !</p>
        
    </div>
    
    <footer style="margin-top: 40px;">&copy; Seafood Shop, 2019</footer>
